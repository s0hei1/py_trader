...
from apps.py_trader.service.schema.base.config_schema import ConfigRead, ConfigCreate
from apps.py_trader.service.schema.base.flags_schema import FlagsRead
...
@base_api.post(path=Routes.Base.ConfigReadLast, response_model=ConfigRead)
...
@base_api.post(path=Routes.Base.ConfigReadHistory, response_model=list[ConfigRead])
async def read_last_config(config_repo: ConfigRepo = Depends(Container.configs_repo)):
